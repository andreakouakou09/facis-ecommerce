<section class="space-y-6">
    ...
    <button class="btn btn-danger" onclick="$dispatch('open-modal', 'confirm-user-deletion')">Supprimer le compte </button>
    
    {{-- <x-danger-button x-data="" x-on:click.prevent="" >{{ __('Delete Account') }}</x-danger-button> --}}
